    ...
    return (
        <div className='mx-5 my-10'>
            ...
            <div className='lg:w-8/12 lg:mx-auto my-10 bg-purple-800 bg-opacity-50 text-white p-2 rounded-2xl'>
                <h1 className='my-2 text-xl font-medium'>Front-End : JavaScript, Reactjs, TailwindCSS, HTML/CSS, RTK</h1>
                <h1 className='my-2 text-xl font-medium'>Back-End : Nodejs, Expressjs, MongoDB, REST API</h1>
